  ...
  if ((sourcesUsed || []).indexOf('member_intro') !== -1) {
    ...
    if (pickBody) {
      if (pickBody.pick.length > 0) {
        text = "Of the people I mentioned, I can set up intros with those who are attending and reachable on WhatsApp. Pick one and I'll ask them for their ok — they see your name and the topic, nothing else. I'll message you the moment they respond; if there's no answer in 7 days I'll let you know and we can try someone else.";
        ...
        text = "None of the people I mentioned can take intro requests right now — intros are running for Summit attendees reachable on WhatsApp. Want other names?";
        interactive = null;
      }
    }
  }
