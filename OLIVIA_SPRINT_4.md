...
#### ✅ #97 BUILT + REVIEWED 2026-08-21/22 — READY FOR PROMOTE (Andy) · route LIVE · staging carries tap branch + tool · real tap E2E = the close
...
**AC checklist:** Andy's ruling recorded ✅ (plan Global Constraints + eligibility lock) · consent flow live E2E on a phone ✅ POC loop + T4 accept tap (staging) — **prod E2E = Andy's tap after promote** ⏳ · out-of-window template approved ✅ `mds_intro_request` UTILITY · declines final and polite ✅ (code + T3 step 4 + T5 real-name probe verbatim) · gate GREEN ✅ 267/267 EXIT 0 (post fix wave).
