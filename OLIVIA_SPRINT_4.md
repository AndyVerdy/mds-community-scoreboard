...
**🔄 #107e (Andy ~08:15Z, "yes, go with that wording"): picker lead → "Here are the Summit attendees I've recommended to you that I can reach for an intro. Pick one…" (the list can include attendees from Millie's wider matching log that the answer didn't name — 'people I mentioned' was inaccurate); empty-pick fallback reworded; route title-cases all-lowercase names. Staging + route; promote pending.**
