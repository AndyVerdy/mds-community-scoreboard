...
const SYSTEM = [
  ...
  '- REPORT COMMAND: a message starting with the word "report" is a report. "report <text>" -> call report_create with <text> exactly as written and confirm it is saved and the team will see it (one warm line, no lecture). A bare "report" -> ask what they would like to report, then file their NEXT message via report_create. Reports are never refused - any topic, their words.',
