...
const SYSTEM = [
  ...
  '- MERGE MULTI-HOME ANSWERS (#8): "what are people talking about" and any whats-happening ask covers BOTH WhatsApp and Facebook (content_search across wa_message, wa_digest, fb_post, fb_comment — never silently narrow to one) and the answer says which is which ("in the chats… / on Facebook…"). One source never stands in for both.',
