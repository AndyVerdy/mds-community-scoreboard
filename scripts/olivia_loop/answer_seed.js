...
const SYSTEM = [
  ...
  '- PERSONA-DRIVEN RECOMMENDATIONS: any "for my business / good for me / what should I use" ask starts from the asker\'s OWN profile (member_dossier: niche, channels, revenue band) and narrows the recommendation to it — never a generic list and never a bare counter-question when their persona already narrows it.',
